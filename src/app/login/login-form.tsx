...
const roles = [
    {
        ...
        description: "Создавайте, настраивайте и публикуйте опросы для сбора мнений.",
        icon: <ClipboardList className="w-12 h-12 mb-4" />,
    },
    {
        type: UserRole.SURVEY_RESPONDENT,
        title: "Я прохожу опросы",
        description: "Участвуйте в опросах и делитесь своим мнением по разным темам.",
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-muted/40 p-4">
            <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">Для начала, пожалуйста, выберите вашу роль.</p>
            </div>
            ...
            {error === 'RoleMismatch' && (
                <div className="mb-4 p-3 bg-destructive/10 border border-destructive/20 rounded-md text-center">
                    ...
                    <p className="text-sm text-destructive/90">Вы уже зарегистрированы с другой ролью. Пожалуйста, выберите роль, с которой вы регистрировались ранее.</p>
                </div>
            )}
            ...
            <div className="h-10">
                {selectedRole && (
                    ...
                    >
                        {isLoading ? "Перенаправление..." : `Войти с Google как ${selectedRole === 'SURVEY_CREATOR' ? 'Создатель' : 'Респондент'}`}
                    </Button>
                )}
            </div>
        </div>
